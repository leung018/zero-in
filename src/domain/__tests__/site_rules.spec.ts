...
describe('SiteRules', () => {
  ...
  it('should be able to automatically trim input', () => {
    ...
    const siteRules2 = new SiteRules2({ blockedDomains: ['  example.com  ', '  example.com  '] })
