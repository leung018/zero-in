...
const preset5217 = () => {
  focusDurationMinutes.value = 52
  longBreakDurationMinutes.value = 17
  focusSessionsPerCycle.value = 1
      ...
      <div class="mb-3">
        ...
        <b-collapse id="preset-info" class="mt-2">
          <div class="p-2 bg-light rounded">
            <p class="small mb-1">
              <b>Default:</b> It uses 26-minute focus sessions followed by 5-minute breaks. After
              four sessions, a longer 19-minute break is taken. The focus-to-break ratio matches the
              52/17 method, but each focus session is cut in half.
            </p>
            <p class="small mb-1">
